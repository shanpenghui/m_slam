#ifndef LOOP_CLOSURE_LOOP_DETECT_SCORING_H_
#define LOOP_CLOSURE_LOOP_DETECT_SCORING_H_
...
const loop_closure::IdToFrameKeyPointMatches<ScoreIdType>& id_to_matches_map,
const loop_closure::IdToNumDescriptors<ScoreIdType>& descriptor_count_per_id,
...
void ComputeAccumulationScore(
    const loop_closure::IdToFrameKeyPointMatches<ScoreIdType>&
        id_to_matches_map,
    const loop_closure::IdToNumDescriptors<ScoreIdType>&
        /*descriptor_count_per_id*/,
    size_t /*num_descriptors_in_database*/, ScoreList<ScoreIdType>*
        scores) {
