#ifndef OCCUPANCY_GRID_XY_INDEX_H_
#define OCCUPANCY_GRID_XY_INDEX_H_
...
class XYIndexRangeIterator
 ...
 public:
    ...
    XYIndexRangeIterator& operator++() {
        // This is a necessary evil. Bounds checking is very expensive and
        // needs to be avoided in production. We have unit tests that exercise
