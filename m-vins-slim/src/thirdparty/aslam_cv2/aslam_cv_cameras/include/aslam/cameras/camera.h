...
class Camera {
 ...
 protected:
  ...
  Camera(const Camera& other) :
    ...
    t_offset_imu_cam_(other.t_offset_imu_cam_),
    label_(other.label_),
    id_(other.id_),
 ...
 public:
  ...
  //////////////////////////////////////////////////////////////
  /// \name Methods for supporting unsync cameras.
  /// @{

  /// \brief  Return the temporal offset of camera wrt. an imu.
  ///         Synchronized camera returns zero.
  /// @return offset = t_imu - t_cam in seconds.
  double getTimeOffsetImuCam() const {
    return t_offset_imu_cam_;
  }

  /// \brief Set the temporal offset of a rolling shutter camera.
  /// @param[in] offset = t_imu - t_cam in seconds.
  void setTimeOffsetImuCam(double t_offset_imu_cam) {
    t_offset_imu_cam_ = t_offset_imu_cam;
  }
 ...
 private:
  ...
  /// The time offset of a camera wrt. an IMU in seconds.
  double t_offset_imu_cam_;
